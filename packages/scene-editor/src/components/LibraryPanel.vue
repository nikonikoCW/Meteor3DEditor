    ...
    <div class="section">
     ...
     <div
      ...
      <div
        class="item"
        draggable="true"
        @dragstart="onDragStart($event, 'PreviewFire')"
      >
        <span class="preview-icon"><span class="iconfont me-huoyanjiare"></span></span>
        <span class="item-name">火焰</span>
      </div>
    </div>
...
const getRegisteredAssetUrl = (asset, fallbackField) => {
  if (asset?.type === 'gaussian-splat' && asset.sourceType === 'upload') return _getAssetUrl(asset);
