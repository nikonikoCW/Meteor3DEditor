    ...
    <div class="section">
      ...
      <div class="prop-row">
        <div class="label-row">
          ...
          <span class="panel-range-value">{{ moveSpeed.toFixed(1) }}</span>
        </div>
        <input
          id="ghost-move-speed"
      ...
      <div class="prop-row">
        <div class="label-row">
          ...
          <span class="panel-range-value">{{ boostMultiplier.toFixed(1) }}×</span>
        </div>
        <input
      ...
      <div class="prop-row">
        <div class="label-row">
          ...
          <span class="panel-range-value">{{ lookSpeed.toFixed(4) }}</span>
        </div>
        <input
          id="ghost-look-speed"
